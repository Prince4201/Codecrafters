if (true){document.write(`<div class="container-fluid text-center bg-transparent text-light masthead-sub">
    <h1 class="mastTitle-sub " ><a href="/" style="text-decoration:none;color:white;"><b>Maths wizard</b></a></h1>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top " style="opacity:0.9;">
            ...
            <a class="navbar-brand" href="/"><img class="rounded" width="50" src="https://www.clipartmax.com/png/middle/305-3053910_mathematics-clipart-icon-calculator-icon.pnghttps://www.clipartmax.com/png/middle/305-3053910_mathematics-clipart-icon-calculator-icon.png"></a>
            ...
            <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
                <ul class="navbar-nav nav nav-fill">
                    ...
                    <li class="nav-item dropdown" >
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="max-height:90vh;overflow:scroll">
                        ...
                        <div>   
                         ...
                         <div>   
                          <div class="dropdown-header"><a class=" text-dark" href="https://simple-sign-up-page-steel.vercel.app/">Trigonometry</a></div>
                    ...
                    <li><a class="nav-item nav-link text-dark pop" href="https://www.udemy.com/course/mathematics-bridging-course-high-school-to-university/?couponCode=NVDIN35" >Request a Course</a>
                      </li>
                      <li><a class="nav-item nav-link text-dark pop" href="https://www.udemy.com/course/mathematics-bridging-course-high-school-to-university/?couponCode=NVDIN35" >Course Catalog</a></li>
                      <li><a class="nav-item nav-link text-dark pop" href="https://learn.org/article_directory/Math_FAQs.html" >FAQ</a></li>
                </ul>
                ...
                <ul class="navbar-nav ml-md-auto text-center">
                    ...
                    <li class="mt-1 mb-0 pop" style="height:40px"><img src="https://www.google.com/imgres?q=theme%20logo%20png&imgurl=https%3A%2F%2Fpng.pngtree.com%2Felement_our%2F20190601%2Fourmid%2Fpngtree-theme-store-image_1347902.jpg&imgrefurl=https%3A%2F%2Fpngtree.com%2Fso%2Ftheme-logo&docid=9dGfnRwoZ10QOM&tbnid=9f1Dy9cSMf5R2M&vet=12ahUKEwjM_qC1u7GIAxXSTGwGHWNZMcgQM3oECDwQAA..i&w=360&h=360&hcb=2&ved=2ahUKEwjM_qC1u7GIAxXSTGwGHWNZMcgQM3oECDwQAA" height="40px" id="themer" class="btn" onclick="toggleTheme(this)">
                    <script>
